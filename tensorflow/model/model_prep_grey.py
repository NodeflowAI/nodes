...
class ModelPrepGrey(QWidget):
    def __init__(self, nodeflow_main, n, nn, config):
        super(ModelPrepGrey, self).__init__()
        ...
        nodeflow_main.createAttribute(node=n, name='Dataset_Name', preset='String', socket=True, plug=True, dataType='str', dataAttr='Classify')
...
class ModelPrepGreyAction(QAction):
    """Main widget"""
    def __init__(self, attrData, config):
        super(ModelPrepGreyAction, self).__init__()
