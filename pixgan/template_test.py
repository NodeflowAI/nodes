...
class TemplateTestAction(QAction):
    """Model Create"""
    def __init__(self, attrData, config):
        super(TemplateTestAction, self).__init__()
        ...
        command = 'python modules/PixGan/test.py --model template'+NAME+DATA+AR+NUM+CPD+RD+GPU
        self.run(command)
