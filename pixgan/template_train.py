...
class TemplateTrain(QWidget):
    def __init__(self, nodeflow_main, n, nn, config):
        super(TemplateTrain, self).__init__()
...
class TemplateTrainAction(QAction):
    """Model Create"""
    def __init__(self, attrData, config):
        super(TemplateTrainAction, self).__init__()
        ...
        command = 'python modules/PixGan/train.py --model template'+NAME+DATA+CPD+EPO+EPO_D+SLF+PF+DID+GPU
        self.run(command)
