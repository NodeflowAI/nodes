...
class YarsRevenge(QWidget):
    def __init__(self, nodeflow_main, n, nn, config):
        super(YarsRevenge, self).__init__()

        nodeflow_main.createAttribute(node=n, name='Program', preset='String', socket=True, plug=True, dataType='str', dataAttr='YarsRevenge-v0')
...
class YarsRevengeAction(QAction):
    """Model Create"""
    def __init__(self, attrData, config):
        super(YarsRevengeAction, self).__init__()
