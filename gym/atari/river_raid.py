...
class RiverRaid(QWidget):
    def __init__(self, nodeflow_main, n, nn, config):
        super(RiverRaid, self).__init__()

        nodeflow_main.createAttribute(node=n, name='Program', preset='String', socket=True, plug=True, dataType='str', dataAttr='Riverraid-v0')
...
class RiverRaidAction(QAction):
    """Model Create"""
    def __init__(self, attrData, config):
        super(RiverRaidAction, self).__init__()
