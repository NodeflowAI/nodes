...
class SpaceInvaders(QWidget):
    def __init__(self, nodeflow_main, n, nn, config):
        ...
        nodeflow_main.createAttribute(node=n, name='Program', preset='String', socket=True, plug=True, dataType='str', dataAttr='SpaceInvaders-v0')
...
class SpaceInvadersAction(QAction):
    """Model Create"""
    def __init__(self, attrData, config):
        super(SpaceInvadersAction, self).__init__()
