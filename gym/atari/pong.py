...
class Pong(QWidget):
    def __init__(self, nodeflow_main, n, nn, config):
        ...
        nodeflow_main.createAttribute(node=n, name='Program', preset='String', socket=True, plug=True, dataType='str', dataAttr='Pong-v0')
...
class PongAction(QAction):
    """Model Create"""
    def __init__(self, attrData, config):
        super(PongAction, self).__init__()
