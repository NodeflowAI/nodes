...
class PitFall(QWidget):
    def __init__(self, nodeflow_main, n, nn, config):
        super(PitFall, self).__init__()

        nodeflow_main.createAttribute(node=n, name='Program', preset='String', socket=True, plug=True, dataType='str', dataAttr='Pitfall-v0')
...
class PitFallAction(QAction):
    """Model Create"""
    def __init__(self, attrData, config):
        super(PitFallAction, self).__init__()
