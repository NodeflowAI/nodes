...
class VideoPinball(QWidget):
    def __init__(self, nodeflow_main, n, nn, config):
        super(VideoPinball, self).__init__()

        nodeflow_main.createAttribute(node=n, name='Program', preset='String', socket=True, plug=True, dataType='str', dataAttr='VideoPinball-v0')
...
class VideoPinballAction(QAction):
    """Model Create"""
    def __init__(self, attrData, config):
        super(VideoPinballAction, self).__init__()
