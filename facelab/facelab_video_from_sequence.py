...
class FacelabVideoFromSequence(QWidget):
    def __init__(self, nodeflow_main, n, nn, config):
        super(FacelabVideoFromSequence, self).__init__()
...
class FacelabVideoFromSequenceAction(QAction):
    """Model Create"""
    def __init__(self, attrData, config):
        super(FacelabVideoFromSequenceAction, self).__init__()
